...
<div align="center">
  ...
  [![Release](https://img.shields.io/badge/Release-v1.0.7-007acc?style=for-the-badge)](https://github.com/Dark87714/pocketcode-ide/releases/latest)
  ...
  <a href="https://github.com/Dark87714/pocketcode-ide/releases/download/v1.0.7/PocketCode-IDE-v1.0.7.apk" target="_blank">
    <img src="https://img.shields.io/badge/DOWNLOAD_LATEST_APK-v1.0.7-2ea44f?style=for-the-badge&logo=android&logoColor=white&labelColor=238636" alt="Download APK v1.0.7" height="48"/>
  </a>
  &nbsp;&nbsp;
  <a href="https://github.com/Dark87714/pocketcode-ide/releases/latest" target="_blank">
    <img src="https://img.shields.io/badge/GITHUB_RELEASES-v1.0.7-007acc?style=for-the-badge&logo=github&logoColor=white&labelColor=1f6feb" alt="GitHub Releases" height="48"/>
  </a>
...
### 1. Download Latest APK (v1.0.7)

| Version | Download Link | File Size | Platform |
| :--- | :--- | :--- | :--- |
| **v1.0.7 (Latest - AI Assistant, Markdown Preview & Project Settings)** | [**Download `PocketCode-IDE-v1.0.7.apk`**](https://github.com/Dark87714/pocketcode-ide/releases/download/v1.0.7/PocketCode-IDE-v1.0.7.apk) | ~8.5 MB | Android 7.0+ |
...
1. Open the downloaded `PocketCode-IDE-v1.0.7.apk` file on your Android device.
